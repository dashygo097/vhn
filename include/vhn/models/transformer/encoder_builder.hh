...
public:
  std::string generate_hparams(const std::string &name,
    ...
    oss << mha_builder.generate_hparams(name + "_mha", dtype, mha_module);
    oss << addnorm_builder.generate_hparams(name + "_addnorm1", dtype,
                                            addnorm1_module);
    oss << ffn_builder.generate_hparams(name + "_ffn", dtype, ffn_module);
  ...
  std::string generate_config(const std::string &name,
    ...
    oss << mha_builder.generate_config(name + "_mha", mha_module);
    oss << addnorm_builder.generate_config(name + "_addnorm1", addnorm1_module);
    oss << ffn_builder.generate_config(name + "_ffn", ffn_module);
    oss << addnorm_builder.generate_config(name + "_addnorm2", addnorm2_module);
